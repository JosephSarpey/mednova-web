import PsychotherapyIntakeForm from "@/components/forms/PsychotherapyIntakeForm";
...
export const metadata: Metadata = {
    title: "Psychotherapy Intake Form | Mednova+ Inc.",
    description: "Secure and easy psychotherapy intake form submission for Mednova+ services.",
};

export default function PsychotherapyIntakeFormPage() {
    return (
