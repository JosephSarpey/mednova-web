      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-20 flex justify-center space-x-2">
                <span className="w-10 h-10 flex items-center justify-center bg-primary text-white font-bold rounded-full cursor-pointer">1</span>
                <span className="w-10 h-10 flex items-center justify-center bg-gray-100 text-black font-bold rounded-full hover:bg-gray-200 transition cursor-pointer">2</span>
                <span className="w-10 h-10 flex items-center justify-center bg-gray-100 text-black font-bold rounded-full hover:bg-gray-200 transition cursor-pointer">3</span>
            </div>
        </div>
      </section>
    </div>
